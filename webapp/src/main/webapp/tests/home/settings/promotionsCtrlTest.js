describe("settingsPromotionsCtrlTest", function() {
    ...
    var $controller, $httpBackend, ApiCallService, Session, authRequestHandlerGET, authRequestHandlerDELETE, $translate, urlGET, urlDELETE;
    ...
    beforeEach(inject(function($injector) {
        ...
        urlGET = ApiCallService.apiUrl() + 'promotion_configuration/1';
        urlDELETE = ApiCallService.apiUrl() + 'promotion_configuration/1';
    ...
    describe('call get promotions api getting successful response', function() {
        it('changes scope variables depending on api call', function() {
            var scope = {};
            $controller('settingsPromotionsCtrl', {$scope: scope, ApiCallService: ApiCallService, Session: Session});
    ...
    describe('call delete promotion api getting unsuccessful response', function() {
        it('changes scope variables depending on api call', function() {
            ...
            var controller = $controller('settingsPromotionsCtrl', {$scope: scope, ApiCallService: ApiCallService, Session: Session});
            expect(scope.showMessage).toBe(false);
            $httpBackend.expectGET(urlGET);
            $httpBackend.flush();
            $httpBackend.expectDELETE(urlDELETE);
