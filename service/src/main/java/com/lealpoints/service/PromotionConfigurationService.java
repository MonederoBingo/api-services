...
@Component
public class PromotionConfigurationService extends BaseService {
    private static final Logger logger = LogManager.getLogger(PromotionConfigurationService.class.getName());
    ...
    @Autowired
    public PromotionConfigurationService(PromotionConfigurationRepository promotionConfigurationRepository,
